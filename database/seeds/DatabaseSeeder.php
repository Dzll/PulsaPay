...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $user = new User();
        // $user->name = 'dzll';
        // $user->email = 'dzll@gmail.com';
        // $user->no_hp = '08886657756';
        // $user->password = Hash::make('123456');
        // $user->remember_token = Hash::make($user->email);
        // $user->save();

        // $user = new User();
        // $user->name = 'aji subarkah';
        // $user->email = 'ajisubarkah99@gmail.com';
        // $user->no_hp = '085940900559';
        // $user->password = Hash::make('123456');
        // $user->save();
        ...
        // $pulsa = new PulsaData();
        // $pulsa->jumlah_pulsa = '50000';
        // $pulsa->masa_aktif = 'masa aktif 30 hari';
        // $pulsa->harga_pulsa = '49000';
        // $pulsa->save();
